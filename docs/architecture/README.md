...
| `CAP-006` team robot support | Inside the wrapper: the one-jar-to-one-bot-directory assumption gave. Wrapper and peer groundwork implemented; team-battle-staging in the harness is not. |
