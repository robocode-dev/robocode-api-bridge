...
| `CAP-006` team robot support | [design](../capabilities/CAP-006-team-robot-support/design.md) | Native team grouping, per-member staging, message routing, and droid behavior |
