...
The earlier versioned-registry change built the append-only evidence carrier and imported a bounded roborumble checkpoint, but `M-006` remains open: the tracked registry has no melee or team subjects and the existing roborumble population is not yet the complete discoverable collection. This change completes the campaign across all three official divisions.
